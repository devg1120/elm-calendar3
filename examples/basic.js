	...
	function (msg, model_) {
		...
		while (true) {
			if (msg.$ === 'SetCalendarState') {
				...
				var _n1 = A4(author$project$Calendar2$update, author$project$Main$eventConfig, author$project$Main$timeSlotConfig, calendarMsg, author$project$Main$model.calendarState);
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A3(author$project$Calendar2$view, author$project$Main$viewConfig, author$project$Fixtures$events, model_.calendarState))
			]));
};
