...
var author$project$Calendar$State = function (a) {
	return {$: 'State', a: a};
};
var author$project$Calendar$Msg$Agenda = {$: 'Agenda'};
var author$project$Calendar$Msg$Day = {$: 'Day'};
var author$project$Calendar$Msg$Month = {$: 'Month'};
var author$project$Calendar$Msg$Week = {$: 'Week'};
var author$project$Calendar$toInternalTimespan = function (timeSpan) {
	switch (timeSpan.$) {
		case 'Month':
			return author$project$Calendar$Msg$Month;
		case 'Week':
			return author$project$Calendar$Msg$Week;
		case 'Day':
			return author$project$Calendar$Msg$Day;
		default:
			return author$project$Calendar$Msg$Agenda;
	}
};
var elm$core$Maybe$Nothing = {$: 'Nothing'};
var author$project$Calendar$Internal$init = F2(
...
var author$project$Calendar$init = F2(
	function (timeSpan, viewing) {
		return author$project$Calendar$State(
			A2(
				author$project$Calendar$Internal$init,
				author$project$Calendar$toInternalTimespan(timeSpan),
				viewing));
	});
...
var author$project$Fixtures$viewing = A2(
	...
	elm$time$Time$utc,
	A7(justinmimbs$time_extra$Time$Extra$Parts, 2016, elm$time$Time$Oct, 4, 16, 0, 0, 0));
var author$project$Main$model = {
	calendarState: A2(author$project$Calendar$init, author$project$Calendar$Month, author$project$Fixtures$viewing)
};
...
var author$project$Calendar$Internal$Drag = F3(
	function (start, current, kind) {
		return {current: current, kind: kind, start: start};
	});
var author$project$Calendar$Internal$Event = function (a) {
	return {$: 'Event', a: a};
};
var author$project$Calendar$Internal$TimeSlot = function (a) {
	return {$: 'TimeSlot', a: a};
};
var author$project$Calendar$Internal$changeTimeSpan = F2(
	function (timeSpan, state) {
		return _Utils_update(
			state,
			{timeSpan: timeSpan});
	});
var author$project$Calendar$Internal$getNewDateBasedOnPosition = F3(
	function (date, xy, state) {
		return date;
	});
var author$project$Calendar$Internal$getTimeDiffForPosition = F2(
	function (xy, state) {
...
var author$project$Calendar$Internal$page = F2(
	function (step, state) {
		var _n0 = state;
...
var author$project$Calendar$Internal$update = F4(
	function (eventConfig, timeSlotConfig, msg, state) {
		switch (msg.$) {
			case 'PageBack':
				return _Utils_Tuple2(
					A2(author$project$Calendar$Internal$page, -1, state),
					elm$core$Maybe$Nothing);
			case 'PageForward':
				return _Utils_Tuple2(
					A2(author$project$Calendar$Internal$page, 1, state),
			...
			case 'ChangeTimeSpan':
				var timeSpan = msg.a;
				return _Utils_Tuple2(
					A2(author$project$Calendar$Internal$changeTimeSpan, timeSpan, state),
					elm$core$Maybe$Nothing);
			case 'TimeSlotClick':
				var date = msg.a;
				var xy = msg.b;
					...
					_Utils_update(
						state,
						{
							dragState: elm$core$Maybe$Just(
								{
									current: xy,
									kind: author$project$Calendar$Internal$TimeSlot(date),
									start: xy
								})
						}),
						...
						state,
						{
							dragState: A2(
								...
								function (_n1) {
									var start = _n1.start;
									var kind = _n1.kind;
									return A3(author$project$Calendar$Internal$Drag, start, me, kind);
								},
								state.dragState)
						}),
					A2(
						timeSlotConfig.onDragging,
						A3(author$project$Calendar$Internal$getNewDateBasedOnPosition, date, me, state),
						me));
			case 'TimeSlotDragEnd':
				...
				return _Utils_Tuple2(
					...
					A2(
						...
						A3(author$project$Calendar$Internal$getNewDateBasedOnPosition, date, xy, state),
						xy));
			case 'EventClick':
				var eventId = msg.a;
				return _Utils_Tuple2(
					...
					_Utils_update(
						state,
						{
							dragState: elm$core$Maybe$Just(
								{
									current: xy,
									kind: author$project$Calendar$Internal$Event(eventId),
									start: xy
								})
						}),
			...
			case 'EventDragging':
				...
				return _Utils_Tuple2(
					...
					A2(
						...
						eventId,
						A2(author$project$Calendar$Internal$getTimeDiffForPosition, me, state)));
			default:
				var eventId = msg.a;
				var xy = msg.b;
				return _Utils_Tuple2(
					...
					A2(
						...
						eventId,
						A2(author$project$Calendar$Internal$getTimeDiffForPosition, xy, state)));
		}
	});
var author$project$Calendar$update = F4(
	function (_n0, _n1, _n2, _n3) {
		var eventConfig_ = _n0.a;
		var timeSlotConfig_ = _n1.a;
		var msg = _n2.a;
		var state = _n3.a;
		var _n4 = A4(author$project$Calendar$Internal$update, eventConfig_, timeSlotConfig_, msg, state);
		var updatedCalendar = _n4.a;
		var calendarMsg = _n4.b;
		return _Utils_Tuple2(
			author$project$Calendar$State(updatedCalendar),
			calendarMsg);
	});
var author$project$Calendar$EventConfig = function (a) {
	return {$: 'EventConfig', a: a};
};
var author$project$Calendar$eventConfig = function (_n0) {
	...
	return author$project$Calendar$EventConfig(
...
var author$project$Main$eventConfig = author$project$Calendar$eventConfig(
	{
		onClick: function (_n0) {
			return elm$core$Maybe$Nothing;
		},
		onDragEnd: F2(
			function (_n1, _n2) {
...
var author$project$Calendar$TimeSlotConfig = function (a) {
	return {$: 'TimeSlotConfig', a: a};
};
var author$project$Calendar$timeSlotConfig = function (_n0) {
	var onClick = _n0.onClick;
	var onMouseEnter = _n0.onMouseEnter;
	var onMouseLeave = _n0.onMouseLeave;
	var onDragStart = _n0.onDragStart;
	var onDragging = _n0.onDragging;
	var onDragEnd = _n0.onDragEnd;
	return author$project$Calendar$TimeSlotConfig(
		{onClick: onClick, onDragEnd: onDragEnd, onDragStart: onDragStart, onDragging: onDragging, onMouseEnter: onMouseEnter, onMouseLeave: onMouseLeave});
};
var author$project$Main$SelectDate = function (a) {
	return {$: 'SelectDate', a: a};
};
var author$project$Main$timeSlotConfig = author$project$Calendar$timeSlotConfig(
	{
		onClick: F2(
			function (date, pos) {
				return elm$core$Maybe$Just(
					author$project$Main$SelectDate(date));
			}),
		onDragEnd: F2(
			function (_n0, _n1) {
				return elm$core$Maybe$Nothing;
...
var author$project$Main$update = F2(
	function (msg, model_) {
		update:
		while (true) {
			if (msg.$ === 'SetCalendarState') {
				var calendarMsg = msg.a;
				var _n1 = A4(author$project$Calendar$update, author$project$Main$eventConfig, author$project$Main$timeSlotConfig, calendarMsg, author$project$Main$model.calendarState);
				...
				if (maybeMsg.$ === 'Nothing') {
					...
					var $temp$msg = updateMsg,
						$temp$model_ = newModel;
					msg = $temp$msg;
					model_ = $temp$model_;
					continue update;
				}
...
var author$project$Calendar$Internal = function (a) {
	return {$: 'Internal', a: a};
};
...
var author$project$Calendar$Agenda$eventsGroupedByDate = F2(
...
var author$project$Calendar$Agenda$viewAgendaHeader = A2(
	elm$html$Html$thead,
	_List_fromArray(
		[
...
var author$project$Helpers$hourString = function (posix) {
	...
	return A2(justinmimbs$date$Date$format, 'h:mm a', date);
};
var elm$html$Html$td = _VirtualDom_node('td');
var author$project$Calendar$Agenda$viewTimeAndEvent = F2(
...
var author$project$Calendar$Agenda$viewAgendaRow = F2(
	function (config, event) {
		return A2(
			elm$html$Html$tr,
			_List_fromArray(
			...
			A2(author$project$Calendar$Agenda$viewTimeAndEvent, config, event));
	});
...
var author$project$Calendar$Agenda$viewAgendaRowWithDate = F3(
...
var author$project$Calendar$Agenda$view = F3(
	function (config, events, posix) {
		...
		var groupedEvents = A2(author$project$Calendar$Agenda$eventsGroupedByDate, config, events);
		var getAgendaRowView = function (eventGroup) {
			...
			if (!_n0.b) {
				...
				return A2(
					elm$core$List$cons,
					A3(author$project$Calendar$Agenda$viewAgendaRowWithDate, config, eventGroup, firstEvent),
					A2(
						elm$core$List$map,
						author$project$Calendar$Agenda$viewAgendaRow(config),
						restOfEvents));
			}
		};
		...
		return A2(
			...
			_List_fromArray(
				[
					author$project$Calendar$Agenda$viewAgendaHeader,
					A2(
					elm$html$Html$tbody,
					_List_fromArray(
						[
...
var author$project$Calendar$Day$viewDate = function (posix) {
	var title_day = A2(
...
var author$project$Calendar$Day$viewTimeGutterHeader = A2(
	elm$html$Html$div,
	_List_fromArray(
		[
	...
	_List_Nil);
var author$project$Calendar$Day$viewDayHeader = function (day) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				author$project$Calendar$Day$viewTimeGutterHeader,
				author$project$Calendar$Day$viewDate(day)
			]));
};
var author$project$Calendar$Day$flip = F3(
	function (_function, argB, argA) {
		return A2(_function, argA, argB);
	});
var author$project$Calendar$Event$fractionalDay = function (date) {
	return 0.5;
};
var elm$core$String$fromFloat = _String_fromNumber;
var elm$virtual_dom$VirtualDom$style = _VirtualDom_style;
var elm$html$Html$Attributes$style = elm$virtual_dom$VirtualDom$style;
var author$project$Calendar$Event$styleDayEvent = F2(
	function (start, end) {
		var startPercent = 100 * author$project$Calendar$Event$fractionalDay(start);
		var startPercentage = elm$core$String$fromFloat(startPercent) + '%';
		var endPercent = 100 * author$project$Calendar$Event$fractionalDay(end);
		var height = elm$core$String$fromFloat(endPercent - startPercent) + '%';
		return _List_fromArray(
			[
...
var author$project$Calendar$Event$eventStyling = F5(
		...
		var styles = function () {
			switch (timeSpan.$) {
				...
				case 'Week':
					return _List_Nil;
				case 'Day':
					return A2(author$project$Calendar$Event$styleDayEvent, eventStart, eventEnd);
				default:
					return _List_Nil;
			}
		}();
...
var author$project$Calendar$Msg$EventClick = function (a) {
	return {$: 'EventClick', a: a};
};
var author$project$Calendar$Msg$EventMouseEnter = function (a) {
	return {$: 'EventMouseEnter', a: a};
};
var author$project$Calendar$Msg$EventMouseLeave = function (a) {
...
var author$project$Calendar$Event$eventSegment = F5(
			...
			_Utils_ap(
				_List_fromArray(
					[
						...
						author$project$Calendar$Msg$EventClick(eventId)),
						elm$html$Html$Events$onMouseEnter(
						author$project$Calendar$Msg$EventMouseEnter(eventId)),
						elm$html$Html$Events$onMouseLeave(
						author$project$Calendar$Msg$EventMouseLeave(eventId))
					]),
				A5(author$project$Calendar$Event$eventStyling, config, event, eventRange, timeSpan, classes)),
			children);
	});
var author$project$Calendar$Event$maybeViewDayEvent = F4(
	function (config, event, selectedId, eventRange) {
		if (eventRange.$ === 'ExistsOutside') {
			return elm$core$Maybe$Nothing;
		} else {
			return elm$core$Maybe$Just(
				A5(author$project$Calendar$Event$eventSegment, config, event, selectedId, eventRange, author$project$Calendar$Msg$Day));
		}
	});
var author$project$Calendar$Event$ContinuesAfter = {$: 'ContinuesAfter'};
var author$project$Calendar$Event$ContinuesAfterAndPrior = {$: 'ContinuesAfterAndPrior'};
var author$project$Calendar$Event$ContinuesPrior = {$: 'ContinuesPrior'};
var author$project$Calendar$Event$ExistsOutside = {$: 'ExistsOutside'};
var author$project$Calendar$Event$StartsAndEnds = {$: 'StartsAndEnds'};
var author$project$Helpers$bumpMidnightBoundary = function (posix) {
	var date = A2(justinmimbs$date$Date$fromPosix, elm$time$Time$utc, posix);
	return (!justinmimbs$date$Date$ordinalDay(date)) ? A4(justinmimbs$time_extra$Time$Extra$add, justinmimbs$time_extra$Time$Extra$Millisecond, 1, elm$time$Time$utc, posix) : posix;
};
...
var author$project$Calendar$Event$rangeDescription = F4(
	function (start, end, interval, posix) {
		var posix_day = author$project$Helpers$bumpMidnightBoundary(posix);
		var day = A2(justinmimbs$date$Date$fromPosix, elm$time$Time$utc, posix_day);
		var endInterval = A3(
			justinmimbs$date$Date$add,
			justinmimbs$date$Date$Days,
			-1,
			A2(justinmimbs$date$Date$ceiling, interval, day));
		var endsAfterInterval = 0 > A3(
			justinmimbs$date$Date$diff,
			justinmimbs$date$Date$Days,
			A2(justinmimbs$date$Date$fromPosix, elm$time$Time$utc, end),
			endInterval);
		var begInterval = A2(justinmimbs$date$Date$floor, interval, day);
		var endsThisInterval = A3(
			justinmimbs$date$Date$isBetween,
			begInterval,
			endInterval,
			A2(justinmimbs$date$Date$fromPosix, elm$time$Time$utc, end));
		var startsBeforeInterval = 0 > A3(
			justinmimbs$date$Date$diff,
			justinmimbs$date$Date$Days,
			begInterval,
			A2(justinmimbs$date$Date$fromPosix, elm$time$Time$utc, start));
		var startsThisInterval = A3(
			justinmimbs$date$Date$isBetween,
			begInterval,
			endInterval,
			A2(justinmimbs$date$Date$fromPosix, elm$time$Time$utc, start));
		return (startsThisInterval && endsThisInterval) ? author$project$Calendar$Event$StartsAndEnds : ((startsBeforeInterval && endsAfterInterval) ? author$project$Calendar$Event$ContinuesAfterAndPrior : ((startsThisInterval && endsAfterInterval) ? author$project$Calendar$Event$ContinuesAfter : ((endsThisInterval && startsBeforeInterval) ? author$project$Calendar$Event$ContinuesPrior : author$project$Calendar$Event$ExistsOutside)));
	});
var author$project$Calendar$Day$viewDayEvent = F4(
	function (config, day, selectedId, event) {
		var eventStart = config.start(event);
		var eventEnd = config.end(event);
		var eventRange = A4(author$project$Calendar$Event$rangeDescription, eventStart, eventEnd, justinmimbs$date$Date$Day, day);
		return A4(author$project$Calendar$Event$maybeViewDayEvent, config, event, selectedId, eventRange);
	});
...
var author$project$Calendar$Day$viewDayEvents = F4(
	function (config, events, selectedId, day) {
		return A2(
			elm$core$List$filterMap,
			A3(author$project$Calendar$Day$viewDayEvent, config, day, selectedId),
			events);
	});
var author$project$Calendar$Msg$TimeSlotClick = F2(
	function (a, b) {
		return {$: 'TimeSlotClick', a: a, b: b};
	});
var author$project$Calendar$Msg$TimeSlotDragStart = F2(
	function (a, b) {
		return {$: 'TimeSlotDragStart', a: a, b: b};
	});
var author$project$Calendar$Msg$TimeSlotMouseEnter = F2(
	function (a, b) {
		return {$: 'TimeSlotMouseEnter', a: a, b: b};
	});
var author$project$Calendar$Msg$TimeSlotMouseLeave = F2(
	function (a, b) {
...
var author$project$Calendar$Day$viewTimeSlot = function (date) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
				...
				function (event) {
					return A2(author$project$Calendar$Msg$TimeSlotClick, date, event);
				}),
				mpizenberg$elm_pointer_events$Html$Events$Extra$Mouse$onEnter(
				function (event) {
					return A2(author$project$Calendar$Msg$TimeSlotMouseEnter, date, event);
				}),
				mpizenberg$elm_pointer_events$Html$Events$Extra$Mouse$onLeave(
				function (event) {
					return A2(author$project$Calendar$Msg$TimeSlotMouseLeave, date, event);
				}),
				mpizenberg$elm_pointer_events$Html$Events$Extra$Mouse$onDown(
				function (event) {
					return A2(author$project$Calendar$Msg$TimeSlotDragStart, date, event);
				})
			]),
		_List_Nil);
};
var author$project$Calendar$Day$viewDaySlotGroup = function (date) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				author$project$Calendar$Day$viewTimeSlot(date),
				author$project$Calendar$Day$viewTimeSlot(date)
			]));
};
...
var author$project$Helpers$hours = function (posix) {
	var posix_day = author$project$Helpers$bumpMidnightBoundary(posix);
	var day = A2(justinmimbs$date$Date$fromPosix, elm$time$Time$utc, posix_day);
	var lastHour = elm$time$Time$millisToPosix(
		justinmimbs$date$Date$toRataDie(
			A2(justinmimbs$date$Date$ceiling, justinmimbs$date$Date$Day, day)));
	var midnight = elm$time$Time$millisToPosix(
		justinmimbs$date$Date$toRataDie(
			A2(justinmimbs$date$Date$floor, justinmimbs$date$Date$Day, day)));
	return A5(justinmimbs$time_extra$Time$Extra$range, justinmimbs$time_extra$Time$Extra$Hour, 1, elm$time$Time$utc, midnight, lastHour);
};
var author$project$Calendar$Day$viewDaySlot = F4(
	function (config, events, selectedId, day) {
		return A2(
			elm$html$Html$div,
			_List_fromArray(
			...
			A2(
				author$project$Calendar$Day$flip(elm$core$Basics$append),
				A4(author$project$Calendar$Day$viewDayEvents, config, events, selectedId, day),
				A2(
					elm$core$List$map,
					author$project$Calendar$Day$viewDaySlotGroup,
					author$project$Helpers$hours(day))));
	});
var elm$html$Html$span = _VirtualDom_node('span');
var author$project$Calendar$Day$viewHourSlot = function (date) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
...
var author$project$Calendar$Day$viewTimeSlotGroup = function (date) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				author$project$Calendar$Day$viewHourSlot(date),
				A2(
				elm$html$Html$div,
				_List_fromArray(
					[
...
var author$project$Calendar$Day$viewTimeGutter = function (date) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
		...
		A2(
			elm$core$List$map,
			author$project$Calendar$Day$viewTimeSlotGroup,
			author$project$Helpers$hours(date)));
};
var author$project$Calendar$Day$view = F4(
	function (config, events, selectedId, day) {
		return A2(
			elm$html$Html$div,
			_List_fromArray(
			...
			_List_fromArray(
				[
					author$project$Calendar$Day$viewDayHeader(day),
					A2(
					elm$html$Html$div,
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							author$project$Calendar$Day$viewTimeGutter(day),
							A4(author$project$Calendar$Day$viewDaySlot, config, events, selectedId, day)
						]))
				]));
	});
var author$project$Calendar$Msg$PageBack = {$: 'PageBack'};
var author$project$Calendar$Msg$PageForward = {$: 'PageForward'};
var elm$html$Html$button = _VirtualDom_node('button');
var author$project$Calendar$Internal$viewPagination = A2(
	elm$html$Html$div,
	_List_fromArray(
		[
		...
		[
			...
			_List_fromArray(
				[
					...
					elm$html$Html$Events$onClick(author$project$Calendar$Msg$PageBack)
				]),
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('elm-calendar--button'),
					elm$html$Html$Events$onClick(author$project$Calendar$Msg$PageForward)
				]),
			_List_fromArray(
				[
...
var author$project$Calendar$Msg$ChangeTimeSpan = function (a) {
	return {$: 'ChangeTimeSpan', a: a};
};
var author$project$Calendar$Internal$viewTimeSpanSelection = function (timeSpan) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('elm-calendar--button'),
						elm$html$Html$Events$onClick(
						author$project$Calendar$Msg$ChangeTimeSpan(author$project$Calendar$Msg$Month))
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('elm-calendar--button'),
						elm$html$Html$Events$onClick(
						author$project$Calendar$Msg$ChangeTimeSpan(author$project$Calendar$Msg$Week))
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('elm-calendar--button'),
						elm$html$Html$Events$onClick(
						author$project$Calendar$Msg$ChangeTimeSpan(author$project$Calendar$Msg$Day))
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('elm-calendar--button'),
						elm$html$Html$Events$onClick(
						author$project$Calendar$Msg$ChangeTimeSpan(author$project$Calendar$Msg$Agenda))
					]),
				_List_fromArray(
					[
...
var author$project$Calendar$Internal$viewTitle = function (viewing) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
...
var author$project$Calendar$Internal$viewToolbar = F2(
	function (viewing, timeSpan) {
		return A2(
			...
			_List_fromArray(
				[
					author$project$Calendar$Internal$viewPagination,
					author$project$Calendar$Internal$viewTitle(viewing),
					author$project$Calendar$Internal$viewTimeSpanSelection(timeSpan)
				]));
	});
var author$project$Calendar$Month$dayOfWeekFromWeekdayNumber = function (n) {
	switch (n) {
		case 1:
			return elm$time$Time$Mon;
		case 2:
...
var author$project$Calendar$Month$toJapaneseWeekday = function (weekday) {
	switch (weekday.$) {
		case 'Mon':
			return '月';
		case 'Tue':
...
var author$project$Calendar$Month$viewDay = function (weekday) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						author$project$Calendar$Month$toJapaneseWeekday(weekday))
					]))
			]));
};
var author$project$Calendar$Month$viewMonthHeader = function () {
	var viewDayOfWeek = function (_int) {
		return author$project$Calendar$Month$viewDay(
			author$project$Calendar$Month$dayOfWeekFromWeekdayNumber(_int));
	};
	return A2(
		elm$html$Html$div,
		_List_fromArray(
...
var author$project$Calendar$Month$viewMonthRowBackground = function (week) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
...
var author$project$Calendar$Event$cellWidth = 100.0 / 7;
var author$project$Calendar$Event$offsetLength = function (date) {
	return author$project$Calendar$Event$cellWidth * (7 % justinmimbs$date$Date$weekdayNumber(date));
};
var author$project$Calendar$Event$offsetPercentage = function (date) {
	return elm$core$String$fromFloat(
		author$project$Calendar$Event$offsetLength(date)) + '%';
};
var author$project$Calendar$Event$styleRowSegment = function (widthPercentage) {
	return _List_fromArray(
		[
...
var author$project$Calendar$Event$rowSegment = F2(
	function (widthPercentage, children) {
		return A2(
			elm$html$Html$div,
			author$project$Calendar$Event$styleRowSegment(widthPercentage),
			children);
	});
var author$project$Calendar$Event$viewMonthEvent = F4(
	function (config, event, selectedId, eventRange) {
		var eventStart = A2(
			justinmimbs$date$Date$fromPosix,
			elm$time$Time$utc,
		...
		var eventWidthPercentage = function (eventRange2) {
			return elm$core$String$fromFloat(author$project$Calendar$Event$cellWidth * numDaysThisWeek) + '%';
		};
		return (author$project$Calendar$Event$offsetLength(eventStart) > 0) ? A2(
			elm$html$Html$div,
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('elm-calendar--row')
			...
			_List_fromArray(
				[
					A2(
					author$project$Calendar$Event$rowSegment,
					author$project$Calendar$Event$offsetPercentage(eventStart),
					_List_Nil),
					A2(
					author$project$Calendar$Event$rowSegment,
					...
					_List_fromArray(
						[
							A5(author$project$Calendar$Event$eventSegment, config, event, selectedId, eventRange, author$project$Calendar$Msg$Month)
						]))
				])) : A2(
			elm$html$Html$div,
			_List_fromArray(
...
var author$project$Calendar$Event$maybeViewMonthEvent = F4(
	function (config, event, selectedId, eventRange) {
		if (eventRange.$ === 'ExistsOutside') {
			return elm$core$Maybe$Nothing;
		} else {
			return elm$core$Maybe$Just(
				A4(author$project$Calendar$Event$viewMonthEvent, config, event, selectedId, eventRange));
		}
	});
...
var author$project$Calendar$Month$viewWeekEvent = F4(
	function (config, week, selectedId, event) {
		var eventStart = config.start(event);
		var eventEnd = config.end(event);
		var eventRange = function (sunday) {
			return A4(author$project$Calendar$Event$rangeDescription, eventStart, eventEnd, justinmimbs$date$Date$Sunday, sunday);
		};
		return A2(
			elm$core$Maybe$andThen,
			A3(author$project$Calendar$Event$maybeViewMonthEvent, config, event, selectedId),
			A2(
				elm$core$Maybe$map,
				eventRange,
...
var author$project$Calendar$Month$viewMonthRowContent = F4(
	function (config, events, selectedId, week) {
		var eventRows = A2(
			...
			A2(
				elm$core$List$filterMap,
				A3(author$project$Calendar$Month$viewWeekEvent, config, week, selectedId),
				events));
...
var author$project$Calendar$Month$viewMonthRow = F4(
	function (config, events, selectedId, week) {
		return A2(
			elm$html$Html$div,
			_List_fromArray(
			...
			_List_fromArray(
				[
					author$project$Calendar$Month$viewMonthRowBackground(week),
					A4(author$project$Calendar$Month$viewMonthRowContent, config, events, selectedId, week)
				]));
	});
...
var author$project$Calendar$Month$view = F4(
	function (config, events, selectedId, viewing) {
		...
		return A2(
			...
			_List_fromArray(
				[
					author$project$Calendar$Month$viewMonthHeader,
					A2(
					elm$html$Html$div,
					_List_fromArray(
						[
					...
					A2(
						elm$core$List$map,
						A3(author$project$Calendar$Month$viewMonthRow, config, events, selectedId),
						weeks))
				]));
	});
var author$project$Calendar$Week$viewWeekDay = F4(
	function (config, events, selectedId, posix) {
		var viewDaySlots = A2(
			elm$core$List$map,
			author$project$Calendar$Day$viewDaySlotGroup,
			author$project$Helpers$hours(posix));
		var dayEvents = A4(author$project$Calendar$Day$viewDayEvents, config, events, selectedId, posix);
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
...
var author$project$Calendar$Week$viewWeekContent = F5(
	function (config, events, selectedId, viewing, days) {
		var weekDays = A2(
			elm$core$List$map,
			A3(author$project$Calendar$Week$viewWeekDay, config, events, selectedId),
			days);
		var timeGutter = author$project$Calendar$Day$viewTimeGutter(viewing);
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
...
var author$project$Calendar$Day$viewAllDayCell = function (days) {
...
var author$project$Calendar$Week$viewDates = function (days) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
		...
		A2(
			elm$core$List$cons,
			author$project$Calendar$Day$viewTimeGutterHeader,
			A2(elm$core$List$map, author$project$Calendar$Day$viewDate, days)));
};
var author$project$Calendar$Week$viewWeekHeader = function (days) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				author$project$Calendar$Week$viewDates(days),
				author$project$Calendar$Day$viewAllDayCell(days)
			]));
};
...
var author$project$Calendar$Week$view = F4(
	function (config, events, selectedId, viewing) {
		...
		return A2(
			...
			_List_fromArray(
				[
					author$project$Calendar$Week$viewWeekHeader(weekRange),
					A5(author$project$Calendar$Week$viewWeekContent, config, events, selectedId, viewing, weekRange)
				]));
	});
var elm$html$Html$Attributes$draggable = _VirtualDom_attribute('draggable');
var author$project$Calendar$Internal$view = F3(
	function (config, events, _n0) {
		...
		var calendarView = function () {
			switch (timeSpan.$) {
				case 'Month':
					return A4(author$project$Calendar$Month$view, config, events, selected, viewing);
				case 'Week':
					return A4(author$project$Calendar$Week$view, config, events, selected, viewing);
				case 'Day':
					return A4(author$project$Calendar$Day$view, config, events, selected, viewing);
				default:
					return A3(author$project$Calendar$Agenda$view, config, events, viewing);
			}
		}();
		return A2(
			elm$html$Html$div,
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							A2(author$project$Calendar$Internal$viewToolbar, viewing, timeSpan),
							calendarView
						]))
				]));
	});
...
var author$project$Calendar$view = F3(
	function (_n0, events, _n1) {
		var config = _n0.a;
		var state = _n1.a;
		return A2(
			elm$html$Html$map,
			author$project$Calendar$Internal,
			A3(author$project$Calendar$Internal$view, config, events, state));
	});
var author$project$Fixtures$eventFour = {
	end: A2(
		justinmimbs$time_extra$Time$Extra$partsToPosix,
		elm$time$Time$utc,
		A7(justinmimbs$time_extra$Time$Extra$Parts, 2016, elm$time$Time$Oct, 21, 4, 0, 0, 0)),
	id: '4',
	start: A2(
		justinmimbs$time_extra$Time$Extra$partsToPosix,
		elm$time$Time$utc,
		A7(justinmimbs$time_extra$Time$Extra$Parts, 2016, elm$time$Time$Oct, 18, 9, 0, 0, 0)),
...
var author$project$Fixtures$eventOne = {
		...
		justinmimbs$time_extra$Time$Extra$partsToPosix,
		elm$time$Time$utc,
		A7(justinmimbs$time_extra$Time$Extra$Parts, 2016, elm$time$Time$Oct, 4, 15, 0, 0, 0)),
	id: '1',
	start: A2(
		justinmimbs$time_extra$Time$Extra$partsToPosix,
		elm$time$Time$utc,
		A7(justinmimbs$time_extra$Time$Extra$Parts, 2016, elm$time$Time$Oct, 4, 13, 30, 0, 0)),
...
var author$project$Fixtures$eventThree = {
		...
		justinmimbs$time_extra$Time$Extra$partsToPosix,
		elm$time$Time$utc,
		A7(justinmimbs$time_extra$Time$Extra$Parts, 2016, elm$time$Time$Oct, 5, 16, 45, 0, 0)),
	id: '3',
	start: A2(
		justinmimbs$time_extra$Time$Extra$partsToPosix,
		elm$time$Time$utc,
		A7(justinmimbs$time_extra$Time$Extra$Parts, 2016, elm$time$Time$Oct, 5, 15, 15, 0, 0)),
	title: 'Paying Bills Alone'
};
var author$project$Fixtures$eventTwo = {
	end: A2(
		justinmimbs$time_extra$Time$Extra$partsToPosix,
		elm$time$Time$utc,
		A7(justinmimbs$time_extra$Time$Extra$Parts, 2016, elm$time$Time$Oct, 5, 14, 10, 0, 0)),
	id: '2',
	start: A2(
		justinmimbs$time_extra$Time$Extra$partsToPosix,
		elm$time$Time$utc,
		A7(justinmimbs$time_extra$Time$Extra$Parts, 2016, elm$time$Time$Oct, 5, 13, 30, 0, 0)),
	title: 'Brunch w/o Friends :('
};
...
var author$project$Calendar$EventView = function (a) {
	return {$: 'EventView', a: a};
};
var author$project$Calendar$eventView = function (_n0) {
	var nodeName = _n0.nodeName;
	var classes = _n0.classes;
	var children = _n0.children;
	return author$project$Calendar$EventView(
		{children: children, classes: classes, nodeName: nodeName});
};
var author$project$Calendar$ViewConfig = function (a) {
	return {$: 'ViewConfig', a: a};
};
var author$project$Calendar$viewConfig = function (_n0) {
	var toId = _n0.toId;
	var title = _n0.title;
	var start = _n0.start;
	var end = _n0.end;
	...
	return author$project$Calendar$ViewConfig(
		{end: end, event: eventView2, start: start, title: title, toId: toId});
};
var author$project$Main$viewConfig = author$project$Calendar$viewConfig(
	{
		end: function ($) {
			return $.end;
		},
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A3(author$project$Calendar$view, author$project$Main$viewConfig, author$project$Fixtures$events, model_.calendarState))
			]));
};
