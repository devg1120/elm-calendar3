...
eventSegment config event selectedId eventRange timeSpan =
    ...
    div [ class "week_event_class"]
      [
       div [style "z-index" "100", style "height" "2px",style "width" "100%", style "background-color" "#ff0000", style "cursor" "n-resize"][]
       ,ev
       ,div [style "height" "2px",style "width" "100%", style "background-color" "#ff0000", style "cursor" "s-resize"][]
       ]
       --}
